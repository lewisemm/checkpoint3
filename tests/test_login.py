...
class TestLogin(TestBaseClass):
	...
	def test_successful_login(self):
		"""
		This method creates a new user and tests successful login thereafter.
		"""
	...
	def test_non_existent_user_login(self):
		"""
		This method tests the attempted login of a user who is not registered in the system.
		"""
	...
	def test_login_missing_credentials(self):
		"""
		This method tests the validation of user input during attempted login.
		"""
		username = self.fake.user_name()
		password = self.fake.password()
