...
class TestBucketListID(TestBaseClass):
	...
	def test_successful_get_bucketlist_id(self):
		"""
		Tests a successful get attempt of a bucketlist of the specified id.
		"""
		# create a user
		self.create_user()
		# login user
		self.client.post('/auth/login', {'username': self.username, 'password': self.password})
		# create a bucketlist
	...
	def test_unauthenticated_get_bucketlist_id(self):
		"""
		Tests an unauthenticated get attempt of a bucketlist of the specified id.
		"""
		# create a user
		self.create_user()
		# login user
	...
	def test_successful_put_bucketlist_id(self):
		"""
		Tests a successful put attempt of a bucketlist of the specified id.
		"""
		# create a user
		self.create_user()
		# login user
		...
		response = self.client.get('/bucketlists/1', data={'name': new_bucketlist_name}, headers={'username': token})
	...
	def test_unauthenticated_put_bucketlist_id(self):
		"""
		Tests an unauthenticated put attempt of a bucketlist of the specified id.
		"""
		# create a user
		self.create_user()
		# login user
		...
		# the put request to bucketlist id 1
		new_bucketlist_name = self.fake.name()
		response = self.client.get('/bucketlists/1', data={'name': new_bucketlist_name})
	...
	def test_successful_delete_bucketlist_id(self):
		"""
		Tests a successful delete attempt of a bucketlist of the specified id.
		"""
		# create a user
		self.create_user()
		# login user
		...
		response = self.client.delete('/bucketlists/1', headers={'username': token})
